...
CASE WHEN resolution_dte IS NULL then to_date(current_date()) ELSE to_date(resolution_dte) end as resolution_dte_for_calcs,
...
project_category,
resolution_dte_raw,
to_timestamp(resolution_dte_transformed) as resolution_dte_transformed,
to_timestamp(resolution_dte_for_calcs) as resolution_dte_for_calcs,
created_dte,
component,
component_is_active,
version_name,
