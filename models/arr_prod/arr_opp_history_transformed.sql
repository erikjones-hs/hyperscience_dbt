...
CASE WHEN opp_id = '0063600000X36zWAAR' then to_date('2020-07-01')
     ...
     when opp_id = '0061R000014vUKMQA2' then to_date('2023-11-15') /* End date adjustment because of open negotiations. USAF 115k */  
     when opp_id = '0061R000014yeOrQAI' then to_date('2023-11-15') /* End date adjustment because of open negotiations. Mathematica 100k */  
