...
CASE WHEN opp_id = '0063600000X36zWAAR' then to_date('2020-07-01')
     ...
     when opp_id = '0061R000014vRzBQAU' then to_date('2023-07-15') /* End date adjustment because of open negotiations. MIssion Underwriters 145k */ 
     when opp_id = '0061R000014wKFCQA2' then to_date('2023-07-15') /* End date adjustment because of open negotiations. Teknei 50k */ 
