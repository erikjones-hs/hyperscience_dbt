...
CASE WHEN opp_id = '0063600000X36zWAAR' then to_date('2020-07-01')
     ...
     when opp_id = '0061R0000135zhLQAQ' then to_date('2022-11-15') /* End date adjustment because of open negotiations. Morris Law 135k */
     when opp_id = '0061R0000137by9QAA' then to_date('2022-11-15') /* End date adjustment because of open negotiations. AIG 555k */
     when opp_id = '0061R0000137hQzQAI' then to_date('2022-11-15') /* End date adjustment because of open negotiations. Allstate 15k */
