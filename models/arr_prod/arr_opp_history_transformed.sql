...
CASE WHEN opp_id = '0063600000X36zWAAR' then to_date('2020-07-01')
  ...
  --   when opp_id = '0061R000019Qd92QAC' then to_date('2024-10-29') /* End date adjustment because it is wrong in SFDC. Ascensus 225k */
     ...
     when opp_id = '0061R00001A6cAuQAJ' then to_date('2024-11-15') /* End date adjustment because of open negotiations. QBE 375k */
     when opp_id = '0061R0000137Uv3QAE' then to_date('2024-11-15') /* USAC */
 --    when opp_id = '0061R00001363r8QAA' then to_date('2024-09-15') /* Border Patrol */
 --    when opp_id = '0061R000016kQjHQAU' then to_date('2024-10-15') /* USCIS $2.3M */
     when opp_id = '0061R000019ROggQAG' then to_date('2024-11-15') /* CompIQ 173.7k */
     when opp_id = '0061R00001CxtHbQAJ' then to_date('2024-11-15') /* USAC 6.4k */
     when opp_id = '0061R000019RV3tQAG' then to_date('2024-11-15') /* Dept of VA 7.6M*/
     when opp_id = '0061R000019R4RlQAK' then to_date('2024-11-15') /* IRS 72k */
