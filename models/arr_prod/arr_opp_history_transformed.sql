...
select 
CASE WHEN opp_id in ('0061R00000zBWKMQA4','0061R000016muACQAY') then '001Dm00000D0MSLIA3'
     WHEN opp_id = '0061R000013fGPFQA2' then '0011R00002TWu7lQAD'
...
CASE WHEN opp_id = '0063600000X36zWAAR' then to_date('2020-07-01')
     ...
     when opp_id = '0061R00001A5kzfQAB' then to_date('2024-08-15') /* Canada Life */  
     ...
     when opp_id = '0061R000010QaunQAC' then to_date('2024-06-15') /* Westpac 130k. Opp replaced by new one */
     when opp_id = '0061R00001A6LOvQAN' then to_date('2024-07-15') /* Missouri Health */
     when opp_id = '0061R000014yM9tQAE' then to_date('2024-08-15') /* Bedag */
     when opp_id = '0061R000010POBOQA4' then to_date('2024-09-15') /* 1800 COntacts */
     when opp_id = '006Dm000002dALYIA2' then to_date('2025-03-15') /* SSA. Updated end date becaue wrong in snapshot */
     when opp_id = '006Dm000005D1cXIAS' then to_date('2025-03-15') /* Canada LIfe. Updated end date because it is wrong in snapshot */
     ...
     when opp_id = '0061R000010R5olQAC' then to_date('2024-12-15') /* Schwab*/
     when opp_id = '0061R00001A4rGJQAZ' then to_date('2025-02-15') /* McKinsey 30k. UPdated to refelect co-term of new deal*/
  --   when opp_id = '006Dm000002dwQEIAY' then to_date('2025-03-15') /* DivvyDose 130k */ 
     when opp_id = '006Dm000002dc2eIAA' then to_date('2025-01-15') /* FM Global 125k*/
     when opp_id = '0061R000019RV3tQAG' then to_date('2025-03-15') /* Dept of VA 7.6M*/
     when opp_id = '006Dm000002cWWgIAM' then to_date('2025-03-15') /* UNUM 500k */
  --   when opp_id = '006Dm000002dcAEIAY' then to_date('2025-03-15') /* Protective Life 120k */
     when opp_id = '006Dm000005OEFZIA4' then to_date('2025-01-15') /* USCIS 1.7M */
  --   when opp_id = '006Pm000006FNs6IAG' then to_date('2025-03-15') /* McKinsey 5k */
     when opp_id = '006Dm000002edmSIAQ' then to_date('2025-03-15') /* Liberty Source 36k */
     when opp_id = '006Dm000003Lp64IAC' then to_date('2025-03-15') /* Outgo 90k */
