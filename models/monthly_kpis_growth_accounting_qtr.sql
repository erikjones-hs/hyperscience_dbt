...
sum(case when customer_category = 'churn' then mrr_change_acct else 0 end) as logo_churn_arr,
sum(case when revenue_category = 'churn' and customer_category = 'active' then mrr_change_acct else 0 end) as arr_churn_arr
from raw_dates
