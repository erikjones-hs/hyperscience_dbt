...
CASE WHEN opp_id = '0063600000X36zWAAR' and to_date(joi.date_month) <= '2019-06-01' then 128000 
     ...
     when opp_id = '0061R00000yFonNQAS' and to_date(joi.date_month) >= '2022-06-01' then 0.00000000001
     when opp_id = '0061R00000zAI8KQAW' and to_date(joi.date_month) >= '2022-06-01' then 0.00000000001
     when opp_id = '0061R00000yEQVgQAO' and to_date(joi.date_month) >= '2022-06-01' then 0.00000000001
