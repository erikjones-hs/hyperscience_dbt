...
CASE WHEN opp_id = '0061R000013fGPFQA2' then 60000 else opp_arr end as opp_arr,
CASE WHEN opp_id = '0061R000013fGPFQA2' then 60000 else opp_net_new_arr end as opp_net_new_arr
from "DEV"."ERIKJONES"."SALESFORCE_AGG_OPPORTUNITY_v19"
...
and (opp_arr > 0 or opp_id = '0061R000013fGPFQA2')
order by account_id, start_dte_raw asc
)

select * from raw_data_inc_19