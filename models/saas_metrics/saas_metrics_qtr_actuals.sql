...
to_decimal(gross_margin_percent,38,2) as gross_margin_percent,
...
gross_margin,
CASE WHEN to_date(date) in ('2023-02-28','2023-05-31','2023-08-31','2023-11-30','2024-02-29','2024-05-31','2024-08-31','2024-11-30','2025-02-28') then gross_margin_percent else 0 end as gross_margin_percent,
...
abs(net_burn) as burn_multiple_numerator,
aws_expense,
...
sum(gross_margin_percent) as gross_margin_percent,
...
NET_NEW_ARR,
BURN_MULTIPLE_NUMERATOR,
to_decimal((burn_multiple_numerator / nullifzero(net_new_arr)),38,2) as burn_multiple,
AWS_EXPENSE,
SOFTWARE_PER_FTE_NUMERATOR,
