...
from "FIVETRAN_DATABASE"."GOOGLE_SHEETS"."FINANCE_BUDGET"
order by date asc
),

budget_qtr_transform as (
select distinct
date,
...
LEGAL_FTE,
ALL_DEPT_FTE
from budget_qtr_aggregate_int
order by qtr_end_dte asc
),

budget_qtr_pivot as (
select * from budget_qtr_aggregate
  unpivot(budget for metric in (ARR, REVENUE, NET_DOLLAR_RETENTION, GROSS_DOLLAR_RETENTION, NET_LOGO_RETENTION,	GROSS_MARGIN, GROSS_MARGIN_PERCENT,	
